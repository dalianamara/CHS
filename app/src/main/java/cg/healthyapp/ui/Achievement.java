...
import cg.healthyapp.BottomNavigation.Report;
...
public class Achievement extends Fragment {
 ImageView backarrow,levelimg,three,seven,ten,fourt;
...
ProgressBar progressBar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view= inflater.inflate(R.layout.fragment_acheivement,null);
    ...
    protected void DialogShow(){
        ...
        View view=getActivity().getLayoutInflater().inflate(R.layout.achievementdialog,null);
