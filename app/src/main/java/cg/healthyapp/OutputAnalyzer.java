...
class OutputAnalyzer {
    private final secondHeartRateScreen activity;
    ...
    OutputAnalyzer(secondHeartRateScreen activity, TextureView graphTextureView, Handler mainHandler) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                Thread thread = new Thread(() -> {
                    ...
                    if (detectValley()) {
                        ...
                        sendMessage(secondHeartRateScreen.MESSAGE_UPDATE_REALTIME, currentValue);
                    }
            ...
            public void onFinish() {
                ...
                if (valleys.size() == 0) {
                    mainHandler.sendMessage(Message.obtain(
                            mainHandler,
                            secondHeartRateScreen.MESSAGE_CAMERA_NOT_AVAILABLE,
                ...
                sendMessage(secondHeartRateScreen.MESSAGE_UPDATE_FINAL, returnValueSb.toString());
